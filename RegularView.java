...
public class RegularView {
	 ...
	 * @param change
	 */
	public void showIdleTextLabel(int change) {
		idleText.setText(String.format("Dispensing Change: %d", change));
	...
	private void createSpecialItem() {
		...
		customItemPanel.setBackground(Color.LIGHT_GRAY);
	...
	private void createItemPanels() {
		...
		itemPnl1.setBackground(Color.RED);
		...
		itemPnl2.setBackground(Color.ORANGE);
		...
		itemPnl3.setBackground(Color.YELLOW);
		...
		itemPnl4.setBackground(Color.GREEN);
		...
		itemPnl5.setBackground(Color.BLUE);
